...
# -- Component 1 (Diya) schema smoke tests, kept from the diya branch ------------------
...
def test_controller_decision_schema():
    decision = ControllerDecision(t_s=2.5, decision="RETRIEVE", reason="test", confidence=0.9)
    assert decision.decision == "RETRIEVE" == ControllerDecisionType.RETRIEVE
